...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/monitoring/master/_listings/vmware/apis.md
...
- name: vRealize Operations 6 - Start Monitoring a Resource
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/monitoring/master/_listings/vmware/apiresourcesepopsmonitorresourceidmonitoringstatestart-put-openapi.md
- name: vRealize Operations 6 - Create an EPOPS Unix MultiProcess Monitor Resource
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/monitoring/master/_listings/vmware/apiresourcesadaptersadapterinstanceid-post-openapi.md
- name: vRealize Operations 6 - Start Monitoring a Resource
  x-api-slug: apiresourcesepopsmonitorresourceidmonitoringstatestart-put
  description: 'TODO: Add Description'
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/VMware_logo.png
